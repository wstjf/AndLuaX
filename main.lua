...
activity.setTitle("AndLuaX+Lite")
...
id="8238c96efa67dd3d12ac8c4c487ec894"
key="c4fa032aeb6e5f3bd9e18875ca6f6784"
--bmob=bmob(id,key)
        ...
        if File(项目文件夹.."/"..a[i].name.."/main.lua").isFile() then
          if File(项目文件夹.."/"..a[i].name.."/init.lua").isFile() then
            ...
            if File(项目文件夹.."/"..a[i].name.."/icon.png").isFile() then
              adp.add{图标=项目文件夹.."/"..a[i].name.."/icon.png",软件名=a[i].name,包名="包名："..c,版本="版本："..d}
             else
              adp.add{软件名=a[i].name,包名="包名："..c,版本="版本："..d}
            end
          end
        end
      end
...
--dofile("/storage/emulated/0/IN.luac")
...
项目列表.onItemLongClick=function(l,v,p,i)
  ...
  项目操作.onItemClick=function(l,v,p,i)
    if p==1 then
      ...
      dialog1.dismiss()
     elseif p==2 then
      x90=io.open(项目文件夹.."/"..标题.."/init.lua"):read("*a")
      ...
      x98=项目文件夹.."/"..标题.."/init.lua"
      x99=标题
      x0=io.open(项目文件夹.."/"..标题.."/init.lua"):read("*a")
     ...
     elseif p==4 then
      ...
      LuaUtil.zip(项目文件夹.."/"..标题,"/sdcard/AndLuaX+/")
      os.execute("mv ".."/sdcard/AndLuaX+/"..标题..".zip".." ".."/sdcard/AndLuaX+/"..标题..".alp")
      Sharing("/sdcard/AndLuaX+/"..标题..".alp")
     elseif p==1 then

      bin("/storage/emulated/0/AndLuaX+/project/"..标题.."/")
      dialog1.dismiss()
     elseif p==3 then
      dialog1.dismiss()
