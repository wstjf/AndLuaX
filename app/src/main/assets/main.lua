...
local plugindir=("/sdcard/AndLuaX+/project")
...
activity.newActivity("main2",android.R.anim.fade_in,android.R.anim.fade_out,{项目文件夹..v.tag.文件夹名称.text,true,v.tag.文件夹名称.text,"/storage/emulated/0/AndLuaX++/project/"..v.tag.软件名.text})
return true
end
...
os.remove("/sdcard/AndLuaX+/"..标题..".alp")
elseif p==1 then
import "java.util.zip.ZipOutputStream"
import "android.net.Uri"
import "java.io.File"
