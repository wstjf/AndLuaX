        ...
        };
        {
          ...
          CardElevation="0dp";
          {
            ...
            },
            {
              LinearLayout;
              onClick=function()
                LuaUtil.copyDir(activity.getLuaDir().."/Verify","/sdcard/AndLuaX+/backup/Verify")
                os.execute("rm -r ".."/sdcard/AndLuaX+/backup/Verify/set1.XY")
                os.execute("rm -r ".."/sdcard/AndLuaX+/backup/Verify/set2.XY")
                os.execute("rm -r ".."/sdcard/AndLuaX+/backup/Verify/set3.XY")
                os.execute("rm -r ".."/sdcard/AndLuaX+/backup/Verify/set4.XY")
                os.execute("rm -r ".."/sdcard/AndLuaX+/backup/Verify/set13.XY")
                local date=os.date("%Y%m%d%H%M%S")
                LuaUtil.zip("/sdcard/AndLuaX+/backup/Verify","/sdcard/AndLuaX+/backup/XColor/","XColor_"..date..".XColor")
                os.execute("rm -r ".."/sdcard/AndLuaX+/backup/Verify")
                local jm=require "crypt"
                local jmh=jm.desencode(io.open("/sdcard/AndLuaX+/backup/XColor/XColor_"..date..".XColor"):read("*a"))
                io.open("/sdcard/AndLuaX+/backup/XColor/XColor_"..date..".XColor","w"):write(jmh):close()
                print("已导出颜色")
              end,
              layout_width="match_parent";
              layout_marginTop="1%h";
            ...
            },
            {
              ...
              onClick=function()
                ...
                function 确定创建工程.onClick()
                  ...
                  LuaUtil.unZip(路径.Text.."J","/sdcard/AndLuaX+/backup/XColor/")
                  os.execute("rm -r "..路径.Text.."J")
                  local ab=io.open("/sdcard/AndLuaX+/backup/XColor/set5.XY"):read("*a")
                  local abc=io.open("/sdcard/AndLuaX+/backup/XColor/set6.XY"):read("*a")
                  local abcd=io.open("/sdcard/AndLuaX+/backup/XColor/set7.XY"):read("*a")
                  local abcde=io.open("/sdcard/AndLuaX+/backup/XColor/set8.XY"):read("*a")
                  local abcdef=io.open("/sdcard/AndLuaX+/backup/XColor/set9.XY"):read("*a")
                  local abcdefg=io.open("/sdcard/AndLuaX+/backup/XColor/set10.XY"):read("*a")
                  local abcdefgh=io.open("/sdcard/AndLuaX+/backup/XColor/set11.XY"):read("*a")
                  local abcdefghi=io.open("/sdcard/AndLuaX+/backup/XColor/set12.XY"):read("*a")
                  switch file_exists("/sdcard/AndLuaX+/backup/XColor/setb.XY")
                   case true
                    local bj=io.open("/sdcard/AndLuaX+/backup/XColor/setb.XY"):read("*a")
                  ...
                  switch file_exists("/sdcard/AndLuaX+/backup/XColor/setbb.XY")
                   case true
                    local bbl=io.open("/sdcard/AndLuaX+/backup/XColor/setbb.XY"):read("*a")
                    io.open(activity.getLuaDir().."/Verify/setbb.XY","w"):write(bbl):close()
                   default
                    io.open(activity.getLuaDir().."/Verify/setbb.XY","w"):write("颜色1"):close()
                  end

                  os.execute("rm -r ".."/sdcard/AndLuaX+/backup/XColor/set5.XY")
                  os.execute("rm -r ".."/sdcard/AndLuaX+/backup/XColor/set6.XY")
                  os.execute("rm -r ".."/sdcard/AndLuaX+/backup/XColor/set7.XY")
                  os.execute("rm -r ".."/sdcard/AndLuaX+/backup/XColor/set8.XY")
                  os.execute("rm -r ".."/sdcard/AndLuaX+/backup/XColor/set9.XY")
                  os.execute("rm -r ".."/sdcard/AndLuaX+/backup/XColor/set10.XY")
                  os.execute("rm -r ".."/sdcard/AndLuaX+/backup/XColor/set11.XY")
                  os.execute("rm -r ".."/sdcard/AndLuaX+/backup/XColor/set12.XY")
                  os.execute("rm -r ".."/sdcard/AndLuaX+/backup/XColor/setb.XY")
                  os.execute("rm -r ".."/sdcard/AndLuaX+/backup/XColor/setbb.XY")
